...
<form id="frmMain" action="/front/customer/writeForm.web" method="POST" encType="UTF-8">
<div id="page">
<div class="container">
		...
		<article>
			...
			<table class="type_02" style="margin-left: auto; margin-right: auto;">
				<tr>
					<th>이용약관 동의(*)</th>
					<td>
					<div style ="overflow:scroll; width : 98%;height: 150px; padding: 10px;">														
					<p>제1조(목적)<br />이 약관은 주식회사 해피핀핀(Happy FinFin) 회사(전자상거래 사업자)가 운영하는 해피핀핀 사이버 몰(이하 “몰”이라 한다)에서															
					...
					<p>제2조(정의)<br />															
						① “몰”이란 해피핀핀(Happy FinFin)이재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여														
					...
					<p>제3조 (약관 등의 명시와 설명 및 개정) <br />① “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소															
						(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호․모사전송번호․전자우편주소, 사업자등록번호, 통신판매업 신고번호,														
						...
						「소비자기본법」 등 관련 법을 위배하지 않는 범위에서 이 약관을 개정할 수 있습니다.<br />④ “몰”이 약관을 개정할 경우에는														
						적용일자 및 개정사유를 명시하여 현행약관과 함께 몰의 초기화면에 그 적용일자 7일 이전부터 적용일자 전일까지 공지합니다.														
						만, 이용자에게 불리하게 약관내용을 변경하는 경우에는 최소한 30일 이상의 사전 유예기간을 두고 공지합니다.														
					...
					<p>제4조(서비스의 제공 및 변경) <br />① “몰”은 다음과 같은 업무를 수행합니다.<br />&nbsp;															
						1. 재화 또는 용역에 대한 정보 제공 및 구매계약의 체결<br />&nbsp; 2. 구매계약이 체결된 재화 또는 용역의 배송<br />&nbsp;														
						3. 기타 “몰”이 정하는 업무<br />② “몰”은 재화 또는 용역의 품절 또는 기술적 사양의 변경 등의 경우에는 장차 체결되는														
						계약에 의해 제공할 재화 또는 용역의 내용을 변경할 수 있습니다.														
						이 경우에는 변경된 재화 또는 용역의 내용 및 제공일자를 명시하여 현재의 재화 또는 용역의 내용을 게시한 곳에														
						즉시 공지합니다.<br />③ “몰”이 제공하기로 이용자와 계약을 체결한 서비스의 내용을 재화등의 품절 또는 기술적 사양의														
					...
					<p>제9조(구매신청) <br />															
						...
						6. 결제방법의 선택<br />② “몰”이 제3자에게 구매자 개인정보를 제공•위탁할 필요가 있는 경우 실제 구매신청 시 구매자의 동의를 받아야 하며, 회원가입 시 미리 포괄적으로 동의를 받지 않습니다.														
						이 때 “몰”은 제공되는 개인정보 항목, 제공받는 자, 제공받는 자의 개인정보 이용 목적 및 보유‧이용 기간 등을 구매자에게 명시하여야 합니다.														
						다만 「정보통신망이용촉진 및 정보보호 등에 관한 법률」 제25조 제1항에 의한 개인정보 취급위탁의 경우 등 관련 법령에 달리 정함이 있는 경우에는 그에 따릅니다.</p>														
					<p>제10조 (계약의 성립)<br />															
					...
					<p>제11조(지급방법)<br />															
						...
						<span>이용약관에 동의하십니까?</span>														
							<input id="flg_user_agreement" name="flg_user_agreement" label="이용약관 동의"													
							msg="이용약관에 동의 하세요" value="Y" type="checkbox">													
						</td>														
					</tr>															
					<tr>															
					<th>개인정보 수집 및 이용 동의(<span style="color: red;">*</span>)</th>														
					<td>															
						<div style ="overflow:scroll; width : 98%;height: 150px; padding: 10px;">														
					...
					<input id="flg_personal_data" name="flg_personal_data" filter="/1/"					
					label="개인정보 수집 및 이용 방침" msg="개인정보 수집 및 이용 방침에 동의하세요"					
				...
				<div class= "center">
					...
					<input type="submit" value="다음단계로" onclick="return checkAgree();" />
				</div>
			</article>
		<aside></aside>
	</section>
